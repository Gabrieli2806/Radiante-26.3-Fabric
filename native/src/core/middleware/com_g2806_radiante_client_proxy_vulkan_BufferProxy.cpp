...
extern "C" {
JNIEXPORT jint JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_allocateBuffer(JNIEnv *, jclass) {
...
JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_initializeBuffer(
...
JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_buildIndexBuffer(
...
JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_queueUpload(JNIEnv *env,
                                                                                     jclass,
                                                                                     jlong ptr,
                                                                                     jint dstId) {
    auto buffers = Renderer::instance().buffers();
...
JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_performQueuedUpload(JNIEnv *, jclass) {
    auto buffers = Renderer::instance().buffers();
    if (buffers == nullptr) return;
    buffers->performQueuedUpload();
}

JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_updateOverlayPostUniform(JNIEnv *,
                                                                                                  jclass,
                                                                                                  jlong ptr) {
    auto buffers = Renderer::instance().buffers();
    if (buffers == nullptr) return;
...
JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_updateWorldUniform(JNIEnv *,
                                                                                            jclass,
                                                                                            jlong ptr) {
    auto buffers = Renderer::instance().buffers();
    if (buffers == nullptr) return;
...
JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_updateSkyUniform(JNIEnv *, jclass, jlong ptr) {
    auto buffers = Renderer::instance().buffers();
    if (buffers == nullptr) return;
...
JNIEXPORT void JNICALL Java_com_g2806_radiante_client_proxy_vulkan_BufferProxy_updateMapping(JNIEnv *, jclass, jlong ptr) {
    auto buffers = Renderer::instance().buffers();
    if (buffers == nullptr) return;
